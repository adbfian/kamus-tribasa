...
import com.bafika.adbfian.tribasaapp.model.AdapterKromo;
 ...
 */
public class KromoFragment extends Fragment implements RecyclerItemClickListener {

    private RecyclerView tampilkata;
    private AdapterKromo adapterKromo;
    private LinearLayoutManager linearLayoutManager;
    private SQLiteDB sqLiteDB;

    public KromoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_kromo, container, false);
        tampilkata = (RecyclerView)view.findViewById(R.id.tampilkata);
        linearLayoutManager = new LinearLayoutManager(getActivity());
        adapterKromo = new AdapterKromo(getActivity());
        adapterKromo.setOnItemClickListener(this);
        tampilkata.setLayoutManager(linearLayoutManager);
        tampilkata.setAdapter(adapterKromo);
        return view;
    }
    ...
    void loadData() {
        ...
        Cursor cursor = sqLiteDB.Get_DataKromo();
        DataKata dataKata;
        ...
        adapterKromo.clear();
        adapterKromo.addAll(daftarKata);
    }

    @Override
    public void onItemClick(int position, View view) {
        DetailActivity.start(getActivity(), adapterKromo.getItem(position));
    }
